...
// Modifica cierta prioridad a un ticket.
void ticket_asignarPrioridad(List*) ;
// Muestra los tickets por prioridad, y por hora.
void ticket_mostrarPendientes(List*) ; 
// Procesa el ticket y lo elimina de la lista.
void ticket_procesarSiguiente(List*) ; 
// Busca el ticket que se desee, mostrando sus datos.
